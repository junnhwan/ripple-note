...
const responseTime = new Trend("feed_latest_anonymous_duration", true);
const successRate = new Rate("feed_latest_anonymous_success");

export default function () {
  const res = http.get(`${baseURL}/api/feed/latest?limit=${limit}`, {
    tags: { endpoint: "feed_latest_anonymous" },
  });
